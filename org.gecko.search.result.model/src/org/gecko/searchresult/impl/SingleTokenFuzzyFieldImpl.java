...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Single Token Fuzzy Field</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link org.gecko.searchresult.impl.SingleTokenFuzzyFieldImpl#isUppercase <em>Uppercase</em>}</li>
 *   <li>{@link org.gecko.searchresult.impl.SingleTokenFuzzyFieldImpl#getMaxEdits <em>Max Edits</em>}</li>
 * </ul>
 *
 * @generated
 */
public class SingleTokenFuzzyFieldImpl extends SingleTokenTermQueryImpl implements SingleTokenFuzzyField {
	 ...
	 * @generated
	 */
	protected SingleTokenFuzzyFieldImpl() {
		super();
	}
	...
	public void setUppercase(boolean newUppercase) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SearchResultPackage.SINGLE_TOKEN_FUZZY_FIELD__UPPERCASE, oldUppercase, uppercase));
	}
	...
	public void setMaxEdits(int newMaxEdits) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SearchResultPackage.SINGLE_TOKEN_FUZZY_FIELD__MAX_EDITS, oldMaxEdits, maxEdits));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SearchResultPackage.SINGLE_TOKEN_FUZZY_FIELD__UPPERCASE:
				return isUppercase();
			case SearchResultPackage.SINGLE_TOKEN_FUZZY_FIELD__MAX_EDITS:
				return getMaxEdits();
		}
