...
// * @since 03.03.2023
// */
//public abstract class BasicSuggestionServiceOld<O, F> implements SuggestionService {
//
//	private static final Logger LOGGER = Logger.getLogger(BasicSuggestionServiceOld.class.getName());
