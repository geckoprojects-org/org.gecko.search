...
public class SearchAdapterFactory extends AdapterFactoryImpl {
   ...
   */
	protected SearchSwitch<Adapter> modelSwitch =
      ...
      @Override
      public Adapter caseIndexDataContainer(IndexDataContainer object) {
        return createIndexDataContainerAdapter();
      }
      @Override
      ...
      @Override
      public Adapter caseDescriptorContainer(DescriptorContainer object) {
        return createDescriptorContainerAdapter();
      }
      @Override
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.gecko.search.core.model.IndexDataContainer <em>Index Data Container</em>}'.
   * <!-- begin-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.gecko.search.core.model.IndexData <em>Index Data</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.gecko.search.core.model.Descriptor <em>Descriptor</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.gecko.search.core.model.DescriptorContainer <em>Descriptor Container</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
   ...
   */
	...
	/**
   * Creates a new adapter for an object of class '{@link org.gecko.search.core.model.IndexConfiguration <em>Index Configuration</em>}'.
   * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
