 ...
 * to initialize the result descriptor registry on startup
...
public interface IResultDescriptorInitializer {
	...
	/**
	 * Returns the list of result descriptors that should be registered
	 * @return the list of result descriptors that should be registered
	 */
	public List<ResultDescriptor> initializeResultDescriptors();
