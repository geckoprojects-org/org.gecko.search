...
/**
 * A Simple Provider that converts a {@link String} to a upper case {@link String}
 * @author Jürgen Albert
 * @since 21.08.2014
 *
 */
@Component(enabled = true)
public class StringToUpperCaseConverter implements IIndexConverter {

	private static final String CONVERTER_ID = "stringToUpperCase";
